...
**NEOFORGE VERSION IS NOW 21.1.144**

## ⚙️ Changes & Fixes

- **Tom's Simple Storage Changes**
  - TSS can only connect to multi-block storage structures now.
    - Create's Vaults, Sophisticated Storage's storage controller and Functional Storage Drawer Controller
    - Should prevent accident network loops and greatly increase performance on servers
  - All beacon functionality for TSS has been disabled. Create's new logistics system is prefered

## :heavy_plus_sign: Mod Additions

- [CobGyms](https://www.curseforge.com/minecraft/mc-mods/cobgyms) - Basic Gym structures for RCT Trainers.
- [FindMe](https://www.curseforge.com/minecraft/mc-mods/findme) - QOL to find items easier.
- [Measurements](https://www.curseforge.com/minecraft/mc-mods/measurements) - QOL for block measurements / for builders.
- [Deeper and Darker](https://www.curseforge.com/minecraft/mc-mods/deeperdarker) - NEW DIMENSION!! - Expands on Ancient Cities, and gives more of a reason to travel to the Deep Dark.
- [Flat Bedrock](https://www.curseforge.com/minecraft/mc-mods/flat-bedrock) - QOL for bedrock dwellers
- [Structurify](https://www.curseforge.com/minecraft/mc-mods/structurify) - Spaces out structures more, gives tools to edit structures.

## :heavy_minus_sign: Removals

- **Myths & Legends** - Not needed / Replaced
- **GuideME** - Not needed (Twas a guide for AE2, which is only in OC)
---
